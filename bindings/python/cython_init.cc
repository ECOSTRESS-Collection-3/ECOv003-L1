...
#endif
PyMODINIT_FUNC CYTHON_INIT_FUNC(cython_sample)(void);
PyMODINIT_FUNC CYTHON_INIT_FUNC(cython_sample2)(void);
}
...
#endif
{
  ...
  CYTHON_INIT_MODULE(module, "cython_sample", CYTHON_INIT_FUNC(cython_sample));
  CYTHON_INIT_MODULE(module, "cython_sample2", CYTHON_INIT_FUNC(cython_sample2));
