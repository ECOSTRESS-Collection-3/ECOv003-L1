...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_EcostressParaxialTransform", (PyCFunction)_wrap_new_EcostressParaxialTransform, METH_NOARGS, (char *)"\n"
		"\n"
