...
class EcostressOrbit(geocal_swig.hdf_orbit.HdfOrbit_EciTod_TimeAcs):
    ...
    def __init__(self, Fname, Extrapolation_pad=5.0, Large_gap=10.0):
        """
        ...
        """
        _ecostress_orbit.EcostressOrbit_swiginit(self, _ecostress_orbit.new_EcostressOrbit(Fname, Extrapolation_pad, Large_gap))
