...
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__EcostressImageGroundConnection_t swig_types[94]
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__EcostressScanMirror_t swig_types[95]
