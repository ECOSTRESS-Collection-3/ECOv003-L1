...
/*-----------------------------------------------
              @(target):= _ecostress_dqi.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__ecostress_dqi

#else
#  define SWIG_init    init_ecostress_dqi

#endif
#define SWIG_name    "_ecostress_dqi"
...
SWIGINTERN PyObject *DQI_GOOD_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "DQI_GOOD",SWIG_From_int(static_cast< int >(Ecostress::DQI_GOOD)));
  return SWIG_Py_Void();
}
...
SWIGINTERN PyObject *DQI_BAD_OR_MISSING_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "DQI_BAD_OR_MISSING",SWIG_From_int(static_cast< int >(Ecostress::DQI_BAD_OR_MISSING)));
  return SWIG_Py_Void();
}


SWIGINTERN PyObject *DQI_NOT_SEEN_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "DQI_NOT_SEEN",SWIG_From_int(static_cast< int >(Ecostress::DQI_NOT_SEEN)));
  return SWIG_Py_Void();
}


SWIGINTERN PyObject *FILL_VALUE_BAD_OR_MISSING_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "FILL_VALUE_BAD_OR_MISSING",SWIG_From_int(static_cast< int >(Ecostress::FILL_VALUE_BAD_OR_MISSING)));
  return SWIG_Py_Void();
}


SWIGINTERN PyObject *FILL_VALUE_STRIPED_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "FILL_VALUE_STRIPED",SWIG_From_int(static_cast< int >(Ecostress::FILL_VALUE_STRIPED)));
  return SWIG_Py_Void();
}


SWIGINTERN PyObject *FILL_VALUE_NOT_SEEN_swigconstant(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *module;
  PyObject *d;
  if (!SWIG_Python_UnpackTuple(args,(char*)"swigconstant", 1, 1,&module)) return NULL;
  d = PyModule_GetDict(module);
  if (!d) return NULL;
  SWIG_Python_SetConstant(d, "FILL_VALUE_NOT_SEEN",SWIG_From_int(static_cast< int >(Ecostress::FILL_VALUE_NOT_SEEN)));
  return SWIG_Py_Void();
}


SWIGINTERN int Swig_var_fill_value_threshold_set(PyObject *) {
  SWIG_Error(SWIG_AttributeError,"Variable fill_value_threshold is read-only.");
  return 1;
}


SWIGINTERN PyObject *Swig_var_fill_value_threshold_get(void) {
  PyObject *pyobj = 0;
  
  pyobj = SWIG_From_int(static_cast< int >(Ecostress::fill_value_threshold));
  return pyobj;
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"FILL_VALUE_STRIPED_swigconstant", FILL_VALUE_STRIPED_swigconstant, METH_VARARGS, NULL},
	 { (char *)"FILL_VALUE_NOT_SEEN_swigconstant", FILL_VALUE_NOT_SEEN_swigconstant, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
# endif
  ...
  SWIG_addvarlink(SWIG_globals(),(char*)"fill_value_threshold",Swig_var_fill_value_threshold_get, Swig_var_fill_value_threshold_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
