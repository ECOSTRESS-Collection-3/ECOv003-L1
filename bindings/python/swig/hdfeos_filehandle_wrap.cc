...
SWIGINTERN PyObject *_wrap_HdfEosFileHandle__v_filename(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  Ecostress::HdfEosFileHandle *arg1 = (Ecostress::HdfEosFileHandle *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_Ecostress__HdfEosFileHandle_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "HdfEosFileHandle__v_filename" "', argument " "1"" of type '" "Ecostress::HdfEosFileHandle const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      result = ((Ecostress::HdfEosFileHandle const *)arg1)->filename();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "HdfEosFileHandle_close", _wrap_HdfEosFileHandle_close, METH_O, "\n"
		...
		"\n"
		""},
	 { "HdfEosFileHandle__v_filename", _wrap_HdfEosFileHandle__v_filename, METH_O, "\n"
		"\n"
		"const std::string & Ecostress::HdfEosFileHandle::filename() const\n"
		"Ecostress::HdfEosFileHandle::filename\n"
		"Filename of file.\n"
		"\n"
		""},
