...
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__EcostressCamera_t swig_types[107]
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__EcostressParaxialTransform_t swig_types[108]
