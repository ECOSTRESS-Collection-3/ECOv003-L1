...
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__EcostressOrbitL0Fix_t swig_types[138]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ConstantSpacingFrameletTimeTable_t swig_types[152]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SubCamera_t swig_types[190]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__TimeTable_t swig_types[191]
...
SWIGINTERN PyObject *_wrap_new_EcostressOrbitL0Fix__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 4) || (nobjs > 4)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_EcostressOrbitL0Fix" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
...
SWIGINTERN PyObject *_wrap_new_EcostressOrbitL0Fix(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args, "new_EcostressOrbitL0Fix", 0, 5, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
...
check_6:
  ...
  if (argc == 5) {
    PyObject *retobj = _wrap_new_EcostressOrbitL0Fix__SWIG_4(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_EcostressOrbitL0Fix_spacecraft_x_mostly_in_velocity_direction(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "EcostressOrbitL0Fix_spacecraft_x_mostly_in_velocity_direction" "', argument " "2"" of type '" "GeoCal::Time""'");
    } else {
  ...
  {
    try {
      result = (bool)((Ecostress::EcostressOrbitL0Fix const *)arg1)->spacecraft_x_mostly_in_velocity_direction(arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_EcostressOrbitL0Fix", _wrap_new_EcostressOrbitL0Fix, METH_VARARGS, "\n"
		"\n"
		"Ecostress::EcostressOrbitL0Fix::EcostressOrbitL0Fix(const std::string &Fname, const blitz::Array< double, 1 > &Pos_off,\n"
		"double Extrapolation_pad=5.0, double Large_gap=10.0, bool\n"
		"Apply_fix=true)\n"
