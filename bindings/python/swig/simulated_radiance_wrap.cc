...
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__GroundCoordinateArray_t swig_types[98]
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__SimulatedRadiance_t swig_types[99]
