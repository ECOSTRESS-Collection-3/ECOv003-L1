...
#define SWIGTYPE_p_boost__shared_ptrT_Ecostress__SimulatedRadiance_t swig_types[180]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__DemMapInfo_t swig_types[204]
