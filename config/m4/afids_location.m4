...
AC_ARG_WITH([afids],
AS_HELP_STRING([--with-afids=DIR], [give directory where afids can be found (optional, default is /pkg/afids/afids_latest)]), [ ac_afids_dir="$withval" ], [ ac_afids_dir="$geocaldir" ])
