...
{
  std::string dn_name = test_data_dir() + "ECOSTRESS_L1A_PIX_80005_001_20150124T204251_0100_02.h5.expected";
  ...
  BOOST_CHECK_CLOSE(r.read_double(200,2000,1,1)(0,0), 7.9505, 1e-2);
  EcostressRadApply r2(dn_name, gain_name, 0);
  BOOST_CHECK_CLOSE(r2.read_double(200,2000,1,1)(0,0), 48.0, 1e-2);
}
