...
class GeoWriteStandardMetadata(WriteStandardMetadata):
    ...
    def __init__(self, *args, orbit_corrected=True, tcorr_before = -9999,
                 tcorr_after = -9999, geolocation_accuracy_qa = "Poor",
                 **kwargs):
        ...
        if((self.orbit_based and orbit_corrected) or
           geolocation_accuracy_qa in ("Best", "Good")):
            ...
            self.data["AutomaticQualityFlagExplanation"] = "Image matching was not successful correcting scene ephemeris/attitude. Ephemeris/attitude may have significant errors."
