...
def test_plot(igc_hres):
    ...
    for i in range(0, 513, 256):
        ...
        slat.append(igc_hres.orbit_data(tm, 0).position_cf.latitude)
        slon.append(igc_hres.orbit_data(tm, 0).position_cf.longitude)
    alat = []
    alon = []
    blat = []
    blon = []
    for i in [0,255,256,511,512]:
        ...
        blat.append(igc_hres.ground_coordinate(ImageCoordinate(i, igc_hres.number_sample-1)).latitude)
        blon.append(igc_hres.ground_coordinate(ImageCoordinate(i, igc_hres.number_sample-1)).longitude)
