...
def create_igccol_from_qa(qa_fname, l1_osp_dir=None, dem=None, raw_att=False,
    ...
    '''Create a IgcCollection from a given qa file, using the same
    input files as it has listed. By default we use the corrected
    llb_att file, but you can optionally select the raw l1a_raw_att
    file.  We add the attribute "scene_list" to the igccol for
    convenience.
