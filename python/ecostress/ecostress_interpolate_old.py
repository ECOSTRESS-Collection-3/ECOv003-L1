# mypy: ignore-errors
# This is old code, likely to go away. Don't worry about typing
...
import os
import math
from ecostress_swig import fill_value_threshold, DQI_STRIPE_NOT_INTERPOLATED
...
class EcostressInterpolateOld(object):
    def __init__(
        self,
        time_table,
        band_mode="5bands",
    ...
    def create_training_data(self, dataset, missing_mask, band_number):
        ...
        while counter < self.training_size:
            ...
            if self.time_table.close_to_scan_edge(random_x_ind, self.grid_size_half):
                continue
...
__all__ = ["EcostressInterpolateOld"]
