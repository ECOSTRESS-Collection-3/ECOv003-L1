...
class L1bGeoProcess:
    ...
    def collect_qa(
        ...
        if tpcol:
            ...
            self.geo_number_tiepoint = self.qa_file.tp_stat[pass_number][
                :, self.qa_file.NUM_TIEPONT_INDEX
            ]
            self.geo_tiepoint_ce68 = self.qa_file.tp_stat[pass_number][
        ...
        for i, radfname in enumerate(self.radlist):
            ...
            if (
                ...
                l1bgeo = L1bGeoGenerate(
                    ...
                    geolocation_number_tiepoint=self.geo_number_tiepoint[i],
                    geolocation_tiepoint_ce68=self.geo_tiepoint_ce68[i],
                )
                l1bgeo.run(pool)
