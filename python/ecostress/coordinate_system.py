...
# Equation 5 in ATB
m_10_to_ef = np.matrix(
    [[1, 0, 0, x_o_10[0]], [0, 1, 0, x_o_10[1]], [0, 0, 1, x_o_10[2]], [0, 0, 0, 1]]
)
...
# Equation 7 in ATB
m_ef_to_jem = np.matrix(
    [[1, 0, 0, x_o_ef[0]], [0, -1, 0, x_o_ef[1]], [0, 0, -1, x_o_ef[2]], [0, 0, 0, 1]]
)
...
# Equation 9 in ATB
m_jem_to_a = np.matrix(
    [[0, -1, 0, x_o_a[0]], [-1, 0, 0, x_o_a[1]], [0, 0, -1, x_o_a[2]], [0, 0, 0, 1]]
)
