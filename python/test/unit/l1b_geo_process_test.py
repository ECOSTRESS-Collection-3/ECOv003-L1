...
def test_sample_1_l1b_geo_process(isolated_dir, test_data_latest):
    l1a_raw_att = (
        Path("/arcdata/smyth/L1A_RAW_ATT/2025/04/18/L1A_RAW_ATT_38454_20250418T100503_0713_01.h5")
    )
    l1_osp_dir = test_data_latest / "l1_osp_dir"
    l1b_rad = [
        Path("/arcdata/smyth/L1B_RAD/2025/04/18/ECOv002_L1B_RAD_38454_019_20250418T104749_0713_01.h5")
    ]
    l1bgeo = L1bGeoProcess(
        prod_dir=Path("."),
        l1a_raw_att=l1a_raw_att,
